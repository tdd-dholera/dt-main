...
const locations = [
  {
    name: "RECREATION SPORTS & ENTERTAINMENT Projects Allowed on Road 55m to 12m",
    text: `Theme Park 
Outdoor Adventure 
Sports, Film City; 
Restaurants, 
...
export default function Table() {
  ...
  return (
    <div
      className=" bg-gradient-to-b from-blue-50 to-gray-100 py-4 px-4 sm:px-6 lg:px-8 space-y-7"
    >
      <div className="w-full max-w-7xl mx-auto space-y-3 max-md:flex flex-col justify-center items-center px-4 py-8 sm:px-6 lg:px-8">
        <p className="text-center text-2xl mb-4">Development Control Regulations for RECREATION SPORTS & ENTERTAINMENT  Zone (as per Minimum Road Row)</p>
