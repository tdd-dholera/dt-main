...
const locations = [
  {
    name: "High Access Corridor Projects Allowed on Road Below 25m",
    text: `Multi‐storey apartment and 
clusters thereof; Serviced 
...
Facility/ Infrastructure/Utility Buildings; Hostels for working 
professionals; Restaurants, 
Food Plazas and Food Streets  
`,
  },
  {
    name: "High Access Corridor Projects Allowed on Road 55m and Above",
    text: `Multi‐storey apartment and 
clusters thereof; Serviced 
apartments; Dormitories/ 
Worker Housing; 
Dharamshala; 
Cinema Hall, Mall 
Petrol/CNG/LPG Pump, Auto 
Service Station, Light Industrial 
Workshop with area less than 
50sqm; Hospital C and D, 
Budget and 3 Star Hotel, 
Junior, Senior and Professional 
Colleges; Multi‐level Parking 
and all use premises given in 
    ...
    <div className=" bg-gradient-to-b from-blue-50 to-gray-100 py-4 px-4 sm:px-6 lg:px-8 space-y-4">
      <div className="w-full max-w-7xl mx-auto space-y-3 max-md:flex flex-col justify-center items-center px-4 py-8 sm:px-6 lg:px-8">
        <p className="text-center text-2xl mb-4">
          Development Control Regulations for High Access Corridor (as per
          Minimum Road Row)
        </p>
