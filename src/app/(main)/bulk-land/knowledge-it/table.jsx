...
const locations = [
  {
    name: "KNOWLEDGE AND IT Projects Allowed on Road Below 25m",
    text: `Office Building with less than 
100 employees; Budget Hotel; 
Restaurants, Food Plazas and 
Food Streets Neighbourhood 
Retail; Dispensary, Community 
Hall; Library; Health Club; Day 
Care Centre; Public 
Facility/Infrastructure/Utility 
Building Villa/Bungalow; 
Terraced/Row House `
  },
  {
    name: "KNOWLEDGE AND IT Projects Allowed on Road 25m to Below 55m",
    text: `Multi‐level Parking; Office 
Business Park; Commercial 
Office; IT Park; Professional 
College; 
3 Star Hotel; Commercial 
Retail; Restaurants, Food 
...
`
  ...
  {
    name: "KNOWLEDGE AND IT Projects Allowed on Road 55m and Above",
    text: `University Campus; Four and 
Five Star Hotel, Multistorey 
Serviced Apartment; Hostel 
and all uses given above except Villa/Bungalow and 
terraced/Row House; 
Petrol/CNG/LPG Pump`
  }
];
  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto space-y-3 max-md:flex flex-col justify-center items-center px-4 py-8 sm:px-6 lg:px-8">
        <p className="text-center text-2xl mb-4">Development Control Regulations for KNOWLEDGE AND IT Zone (as per Minimum Road Row)</p>
