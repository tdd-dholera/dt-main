...
const faqs = [
  {
    question: "What can be built in Dholera’s Knowledge and IT Zone?",
    answer:
      "This zone allows IT parks, offices, colleges, hotels, shops, restaurants, and other support buildings based on road size rules.",
  },
  {
    question: "Why should I invest in the Knowledge and IT Zone?",
    answer:
      "It is planned for IT, research, education, and business growth, which can help increase land demand and future value.",
  },
  {
    question: "Who can invest in the Knowledge and IT Zone?",
    answer:
      "IT companies, startups, schools, colleges, office users, and long-term investors can consider this zone.",
  },
  {
    question: "Why is this zone important in Dholera Smart City?",
    answer:
      "It is designed as an innovation hub for technology, learning, and skilled jobs in Dholera Smart City.",
  },
  {
    question: "What is the starting investment in this zone?",
    answer:
      "The page promotes government-approved bulk land in this zone starting from ₹2 Cr, with an area of 3,039.32 sq. yards.",
  },
];
