...
const locations = [
  {
    name: "Industrial Projects Allowed on Road Below 30m",
    text: `All industrial establishments 
Industrial sheds, utility 
buildings, industrial plants; 
Light industry; Service 
workshop; Café/Restaurant/ 
Canteen; Bank; 
Warehouse/Godown/Storage 
Facility; Dormitories `
  },
  {
    name: "Industrial Projects Allowed on Road 30m to Below 55m",
    text: `Industrial Convenience 
Centre; Petrol/CNG/LPG 
Station; Auto Service Station; 
Weighing 
Station; Fire Station; Solid 
